...
**Mobox-XFCE** - Emulator works with Box86, Box64, Turnip, DXVK, and more.
...
curl -s -o ~/x https://raw.githubusercontent.com/Shephard225/Mobox-XFCE/main/install && . ~/x
...
## Mobox-XFCE Configuration application :
